...
namespace Provausio.Core.WebClient
{
    ...
    {
        private List<KeyValuePair<string, string>> _segments = new List<KeyValuePair<string, string>>();
        private QueryParameterCollection _queryParameters = new QueryParameterCollection();
        ...
        private bool _addTrailingSlashBeforeQuery;
        ...
        public IResourceBuilder WitUserAgent(string useragent)
        {
        ...
        private string GetUriString()
        {
            ...
            {
                if (_addTrailingSlashBeforeQuery)
                    sb.Append("/");
        ...
        {
            _addTrailingSlashBeforeQuery = true;
        }
        ...
        public void Reset()
        {
            ...
            _addTrailingSlashBeforeQuery = false;
            _segments = new List<KeyValuePair<string, string>>();
